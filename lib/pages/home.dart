...
class _HomeState extends State<Home> {
        ...
        actions: <Widget>[
          MaterialButton(onPressed: (){
            ...
            setState(() {
              print(todos.length);
              todos.add(
                  ToDo(todos.length, controllerText.text.toString(), false)
              );
              todos.sort((a, b) {
                if(b.isDone) {
                  return -1;
  ...
  return   GestureDetector(
    ...
    setState(() {
      // print();
      todos.elementAt(todos.indexWhere((element) => element.key==temp.key)).isDone=!temp.isDone;
      todos.sort((a, b) {
        if(b.isDone) {
          return -1;
        }
        ...
        Text(temp.text,
          style: TextStyle(
            fontSize: 17,
              ...
              decoration :  temp.isDone? TextDecoration.lineThrough:null,
